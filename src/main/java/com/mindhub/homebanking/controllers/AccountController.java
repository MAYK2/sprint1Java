...
public class AccountController {
    ...
    public ResponseEntity<AccountDTO> getClientAccountById(@PathVariable Long id, Authentication authentication) {
        return accountService.getClientAccountById(id, authentication);
    }
